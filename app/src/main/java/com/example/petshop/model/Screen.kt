...
sealed class Screen(val route: String, val title: String) {
    ...
    data object FollowShipping : Screen(route = "follow_shipping/{orderId}", title = "Theo dõi đơn hàng") {
        fun createRoute(orderId: String) = "follow_shipping/$orderId"
    }
    data object SelectPayMethod : Screen(route = "select_pay_method", title = "Phương thức thanh toán")
